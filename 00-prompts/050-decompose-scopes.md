...
3. Produce proposed scopes, dependencies, cross-cutting concerns, rejected alternatives, and a recommended project mode.
4. For a coherent small project, recommend `single-scope` and retain MAIN only.
5. For multiple scopes, populate `proposed_scopes` without activating them.
6. Request `Approve Scope Decomposition v1.0` after review.
